...
class _DetailPelangganState extends State<DetailPelanggan> {
  _DetailPelangganState(){
    ...
    final TextEditingController  _menupesanan = TextEditingController();
     ...
     final _PembayaranMetodeList = ["CASH","BCA","OVO","DANA","GOPAY","MANDIRI"];
                  ...
                  Row(
                    children: [
                      Padding(
                        ...
                        child: Container(
                          child: Text("Waktu Pemesanan ",style: TextStyle(fontSize: 35,fontWeight: FontWeight.w600,color: Colors.white)),
                        ),
                      ),
                       Padding(
                        padding: EdgeInsets.only(left: 80,top: 90),
                        child: Container(
                          child: Text(": ",style: TextStyle(fontSize: 35,fontWeight: FontWeight.w600,color: Colors.white)),
                        ),
                      ),
                      Padding(
                         padding: EdgeInsets.only(left: 100,top: 90),
                   ...
                   Row(
                    children: [
                      Padding(
                        padding: EdgeInsets.only(left: 100,top: 90),
                        child: Container(
                          child: Text("Nomor Meja ",style: TextStyle(fontSize: 35,fontWeight: FontWeight.w600,color: Colors.white)),
                        ),
                      ),
                        Padding(
                   ...
                   Row(
                    children: [
                      Padding(
                        padding: EdgeInsets.only(left: 100,top: 90),
                        child: Container(
                          child: Text("Nama Customer ",style: TextStyle(fontSize: 35,fontWeight: FontWeight.w600,color: Colors.white)),
                        ),
                      ),
                        Padding(
                   ...
                   Row(
                    children: [
                      Padding(
                        padding: EdgeInsets.only(left: 100,top: 90),
                        child: Container(
                          child: Text("Menu Pesanan",style: TextStyle(fontSize: 35,fontWeight: FontWeight.w600,color: Colors.white)),
                        ),
                      ),
                        Padding(
                   ...
                   Row(
                    children: [
                      Padding(
                        padding: EdgeInsets.only(left: 100,top: 90),
                        child: Container(
                          child: Text("Pembayaran",style: TextStyle(fontSize: 35,fontWeight: FontWeight.w600,color: Colors.white)),
                        ),
                      ),
                        Padding(
              ...
              children: [
                InkWell(
                  child: Container(
                    width: 500,
                    height: 80,
                    child: Center(child: Text("Konfirmasi",style: TextStyle(fontSize: 30,fontWeight: FontWeight.w600,color: Colors.black),)),
                    decoration: BoxDecoration(
