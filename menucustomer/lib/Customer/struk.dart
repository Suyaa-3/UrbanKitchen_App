                ...
                children: [
                  Container(
                    ...
                    child: Text("Pancake Urban",style: TextStyle(fontSize: 30,fontWeight: FontWeight.w600),),
                     ...
                     Container(
                      width: 320,
                      child: Center(child: Text("3",style: TextStyle(fontSize: 30,fontWeight: FontWeight.w600),)),
                                     ),
                   
                     Container(
                      width: 430,
                      child: Center(child: Text("Rp. 120.000",style: TextStyle(fontSize: 30,fontWeight: FontWeight.w600),)),
                                     ),
              ...
              Padding(
               ...
               child: Row(
                children: [
                   Container(
                    width: 370,
                    child: Text("Urban Wings",style: TextStyle(fontSize: 30,fontWeight: FontWeight.w600),),
                  ),
                  
                     Container(
                      width: 320,
                      child: Center(child: Text("4",style: TextStyle(fontSize: 30,fontWeight: FontWeight.w600),)),
                                     ),
                ...
                children: [
                 Container(
                    ...
                    child: Text("Urban's Iced Coffee",style: TextStyle(fontSize: 30,fontWeight: FontWeight.w600),),
                     ...
                     Container(
                      width: 320,
                      child: Center(child: Text("5",style: TextStyle(fontSize: 30,fontWeight: FontWeight.w600),)),
                                     ),
                ...
                children: [
                  Container(
                   ...
                   Padding(
                    ...
                    Padding(
                     padding: EdgeInsets.only(left: 660),
                     child: Container(
                      child: Text("Rp. 999.000",style: TextStyle(fontSize: 30,fontWeight: FontWeight.w600),),
                                     ),
                   ),
