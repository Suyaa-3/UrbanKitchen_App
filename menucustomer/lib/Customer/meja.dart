...
class Meja extends StatelessWidget {
  @override
                          ...
                          child: Column(
                            children: [
                              Container(
                                ...
                                height: 180,
                                child:
                                Image(image: AssetImage('assets/images/Meja.png'),),
                              ),
                              Container(
                                child: Text("B5 - Lantai 2",style: GoogleFonts.getFont(
                                  'Kavoon',
                                fontSize: 20,
                                )),
                              ),
                               Container(
                                child: Text("Untuk 4 Orang",style: GoogleFonts.getFont(
                                  'Inter',
                                fontSize: 20,
                                )),
                              ),
                 ...
                 children: [
                   Container(
                               ...
                               Container(
                                 alignment: Alignment.centerLeft,
                                margin: EdgeInsets.only(left: 70,top: 35),
                                child: Text("baris 5 kolom 2",style: GoogleFonts.getFont(
                                  'Inter',
                                fontSize: 30,
                                 color: Colors.white
                                )),
