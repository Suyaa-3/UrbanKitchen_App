...
import 'package:urbankitchen/halamantotal/detailtotal/bulanan/detailtotalbulanan.dart';
...
class PengeluaranBulanan extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   ...
   Container(
    ...
    child: Text("Detail Pengeluaran Bulanan",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),),
   ),
     Container(
