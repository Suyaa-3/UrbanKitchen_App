...
class AdminCabang extends StatelessWidget {
        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              ...
              child: Center(child: Text("Update Stok",style: TextStyle(fontSize: 11),)),
            ),
          ],
        ),
      ),
        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              ...
              child: Center(child: Text("Update Menu",style: TextStyle(fontSize: 11),)),
            ),
          ],
        ),
      ),
